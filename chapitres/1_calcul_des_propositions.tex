...
Les preuves de l'impliquant $B$ dans l'arbre de dérivation sont \og \textit{déchargées} \fg{} par $({\Rightarrow{}}I)$, ce que l'on note par une paire de crochets (\og [ \fg{} et \og ] \fg{}).
